...
\added{3}{
    \begin{example}
        ...
        \begin{itemize}
            ...
            \item The action $\mathcal{R}_Y$ is defined as such: for $\alpha \in G(Y)$ and say $\sigma = \sigma_2\sigma_1\sigma_3$, we have
            ...
            \item Let $\mathcal{C} = \{\{1,3\},\{2\},\{2,3\}\}$. Then $\Omega_{\mathcal{C}}$
        \end{itemize}
    \end{example}}
