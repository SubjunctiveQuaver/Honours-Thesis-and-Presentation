...
Thus, in the procedure to prove the main theorem, we use our implementation of \texttt{GreedyBase} instead of \texttt{BaseOfGroup} to compute a base for $G$. Both algorithms are fast; since
