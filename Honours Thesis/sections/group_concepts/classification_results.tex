...
\added{4}{\begin{example}\label{eg:elem_abelian_perm_group}
    ...
    which is a permutation representation of the Klein 4-group $(\Z/2\Z)^2$ (as every nontrivial element has order 2). However, it is not primitive: $\Sigma = \{\{1,2\},\{3,4\}\}$ is a block system, as shown by the below \texttt{GAP} code:
