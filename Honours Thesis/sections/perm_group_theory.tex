...
\added{4}{The first three families are infinite families of groups, but the classification result shows that there are precisely 26 exceptions to the classification of finite simple groups into cyclic, alternating, and groups of Lie type. The existence of sporadic groups was first theorised by
