...
\lstinputlisting{txt_files/agl_base_gap_output/1.txt}

Below is output for $d = 2$:

\lstinputlisting{txt_files/agl_base_gap_output/2.txt}

Below is output for $d = 3$:

\lstinputlisting{txt_files/agl_base_gap_output/3.txt}
...
\lstinputlisting{txt_files/agl_base_gap_output/7.txt}

Below is output for $d = 8$:

\lstinputlisting{txt_files/agl_base_gap_output/8.txt}

Below is output for $d = 9$:

\lstinputlisting{txt_files/agl_base_gap_output/9.txt}

Below is output for $d = 10$:

\lstinputlisting{txt_files/agl_base_gap_output/10.txt}
