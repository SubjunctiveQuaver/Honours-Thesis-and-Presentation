...
%     \onslide<2->{In \textbf{solved state} $1$, label smaller faces (except each centre) using $[48]$:}
...
\begin{slide}
    ...
    \onslide<2->{\scriptsize{Under $F$: $[17,18,19,20,21,22,23,24] \mapsto [22,20,17,23,18,24,21,19]$ (red), etc. So
            \onslide<3->{$$F = (17,22,24,19)(18,20,23,21)( 6,16,43,25)( 7,13,42,28)( 8,11,41,30) \in \Sym(48).$$}}}
\end{slide}
