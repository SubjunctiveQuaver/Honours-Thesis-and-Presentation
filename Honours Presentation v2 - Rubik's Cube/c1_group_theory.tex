...
\begin{slide}
    \begin{example}[dihedral group]
        \vspace{0pt}
        Let $r = (1,2,3,4),s = (1,4)(2,3) \in \Sym(4)$. \textbf{Dihedral group} is $D_8 := \langle r,s \rangle = \{1,r,r^2,r^3,s,sr,sr^2,sr^3\}$.

        \textit{Note:} $sr = (2,4)$, $sr^2 = (1,2)(3,4)$. Natural action of $D_8$ on $[4]$:
        ...
        \begin{center}
            \begin{tikzpicture}[x=1cm,y=1cm]
                ...
                % TOP LEFT
                \tikzset{EdgeStyle/.style={-}}
                \onslide<2->{\Vertex[Lpos=180]{1} \SO[Lpos=180](1){2} \EA(2){3} \NO(3){4}
                \Edges(1,2,3,4,1)
                \tikzset{EdgeStyle/.style={->}}
                \tkzDefPoint(1.5,-0.5){a1}
                \tkzDefPoint(3.5,-0.5){a2}
                \onslide<3->{\Edge[label=$r$,labelstyle={fill=metropolis}](a1)(a2)
                \tkzDefPoint(2.5,0){l1}\tkzLabelPoint[centered](l1){$\curvearrowright$}
                ...
                \onslide<6->{\Edge(l4)(l5)} % sr
                % TOP RIGHT
                \tikzset{EdgeStyle/.style={-}}
                \onslide<3->{\Vertex[x=4,y=0,Lpos=180]{2} \SO[Lpos=180](2){3} \EA(3){4} \NO(4){1}
                \Edges(1,2,3,4,1)}
                \tikzset{EdgeStyle/.style={->}}
                \tkzDefPoint(0.5,-1.5){a1}
                \tkzDefPoint(0.5,-2.5){a2}
                \onslide<4->{\Edge[label=$s$,labelstyle={fill=metropolis}](a1)(a2)}
                \tkzDefPoint(4.5,0.25){l2}
                \tkzDefPoint(4.5,-1.25){l3}
                \tikzset{EdgeStyle/.style={dotted}}
                \onslide<7->{\Edge(l2)(l3)} % sr^2
                % BOTTOM LEFT
                \tikzset{EdgeStyle/.style={-}}
                \onslide<4->{\Vertex[x=0,y=-3,Lpos=180]{4} \SO[Lpos=180](4){3} \EA(3){2} \NO(2){1}
                \Edges(1,2,3,4,1)}
                \tikzset{EdgeStyle/.style={->}}
                \tkzDefPoint(1.5,-3.5){a1}
                \tkzDefPoint(3.5,-3.5){a2}
                \onslide<5->{\Edge[label=$r$,labelstyle={fill=metropolis}](a1)(a2)
                \tkzDefPoint(2.5,-3){l1}\tkzLabelPoint[centered](l1){$\curvearrowleft$}}
                % BOTTOM RIGHT
                \tikzset{EdgeStyle/.style={-}}
                \onslide<5->{\Vertex[x=4,y=-3,Lpos=180]{1} \SO[Lpos=180](1){4} \EA(4){3} \NO(3){2}
                \Edges(1,2,3,4,1)}
                \tikzset{EdgeStyle/.style={->}}
                \tkzDefPoint(4.5,-1.5){a1}
                \tkzDefPoint(4.5,-2.5){a2}
                \onslide<7->{\Edge[label=$sr^2$,labelstyle={fill=metropolis}](a1)(a2)}
                \tkzDefPoint(1.5,-1.5){a1}
                \tkzDefPoint(3.5,-2.5){a2}
                \onslide<6->{\Edge[label=$sr$,labelstyle={fill=metropolis}](a1)(a2)}}}
            \end{tikzpicture}
        \end{center}
    \end{example}
\end{slide}
