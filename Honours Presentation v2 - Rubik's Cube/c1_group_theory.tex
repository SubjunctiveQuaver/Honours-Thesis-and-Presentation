...
\begin{slide}
    \begin{example}[dihedral group]
        ...
        \onslide<2->{\textit{Note:} $sr = (2,4)$, $sr^2 = (1,2)(3,4)$. Natural action of $D_8$ on $[4]$:}
        ...
        \begin{center}
            \begin{tikzpicture}[x=1cm,y=1cm]
                ...
                \onslide<3->{\Vertex[Lpos=180]{1} \SO[Lpos=180](1){2} \EA(2){3} \NO(3){4}
                    ...
                    \onslide<4->{\Edge[label=$r$,labelstyle={fill=metropolis}](a1)(a2)
                        ...
                        \onslide<7->{\Edge(l4)(l5)} % sr
                        % TOP RIGHT
                        \tikzset{EdgeStyle/.style={-}}
                        \onslide<4->{\Vertex[x=4,y=0,Lpos=180]{2} \SO[Lpos=180](2){3} \EA(3){4} \NO(4){1}
                            \Edges(1,2,3,4,1)}
                        \tikzset{EdgeStyle/.style={->}}
                        \tkzDefPoint(0.5,-1.5){a1}
                        \tkzDefPoint(0.5,-2.5){a2}
                        \onslide<5->{\Edge[label=$s$,labelstyle={fill=metropolis}](a1)(a2)}
                        ...
                        \onslide<6->{\Edge[label=$r$,labelstyle={fill=metropolis}](a1)(a2)
                        ...
                        \onslide<8->{\Edge[label=$sr^2$,labelstyle={fill=metropolis}](a1)(a2)}
                        \tkzDefPoint(1.5,-1.5){a1}
                        \tkzDefPoint(3.5,-2.5){a2}
                        \onslide<7->{\Edge[label=$sr$,labelstyle={fill=metropolis}](a1)(a2)}}}
            \end{tikzpicture}
        \end{center}
    \end{example}
\end{slide}
