...
\begin{slide}
    ...
    \onslide<2->{Write $1 = ()$ for identity. Write $i^g$ instead of $g(i)$ for \textit{image}.
...
\begin{slide}
    ...
    \begin{example}[dihedral group]
        \vspace{0pt}
        Let $r = (1,2,3,4),s = (1,4)(2,3) \in \Sym(4)$. \textbf{Dihedral group} is $D_8 := \langle r,s \rangle = \{1,r,r^2,r^3,s,sr,sr^2,sr^3\}$, \textit{``symmetries of square''} (e.g. $srsr^2 = r$).
    \end{example}
\end{slide}
