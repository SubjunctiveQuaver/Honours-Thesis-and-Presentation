...
\begin{slide}
    ...
    \textit{Note:} for Rubik's group, $R$ has order 4, $RUR^{-1}U^{-1}$ has order 6, $RU$ has order 105 (\texttt{GAP}). Order 7? \pause $(RU)^{15}$. Order 13? \pause None; $|\RC| = 2^{27} \cdot 3^{14} \cdot 5^3 \cdot 7^2 \cdot 11$. 
